export default {
  ...
  header: {
    ...
    text: ['Veselin S Kanchev'],
    typical: [
      'I build applications that scale and deliver the best possible UX across different browsers.I put my focus on cost efficiency, scalability and maintainability.',
      200,
    ],
    btnText: 'Find More',
  },
  work: {
    title: ' Some Projects',
    img1: process.env.PUBLIC_URL + '/assets/Ritmon.png',
    img2: process.env.PUBLIC_URL + '/assets/chore-door-bot.png',
    img3: process.env.PUBLIC_URL + '/assets/wanderlust-api.png',
    img4: process.env.PUBLIC_URL + '/assets/image-engine.png',
    img5: process.env.PUBLIC_URL + '/assets/ehoje.png',
    img6: process.env.PUBLIC_URL + '/assets/iscargo.png',
    imgPlaceholder:
  ...
  stack: {
    ...
    tech: [
      {
        img: process.env.PUBLIC_URL + '/assets/svelte.png',
        alt: 'svelte',
      },
      {
      ...
      // {
      //   img: process.env.PUBLIC_URL + '/assets/vuejs.svg',
      //   alt: 'vuejs',
      // },
      {
        img: process.env.PUBLIC_URL + '/assets/tailwindcss.png',
        alt: 'tailwind',
      },
    ],
    desc: `My frontend development stack evolve from utilising basic HTML, CSS and sprinkles of Javascript to leveraging modern workflows.`,
  },
  icons: {
    title: 'Stack',
    tech: [
